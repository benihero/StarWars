...
public class SearchPlanets extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_planets);
    ...
    private void searchPeople(String tagword)
    {
        ...
        Call<PlanetResult> call = APIClient.get().searchPlanets(tagword);

        call.enqueue(new Callback<PlanetResult>()
        {
            @Override
            public void onFailure(Call<PlanetResult> call, Throwable t)
            {
            ...
            @Override
            public void onResponse(Call<PlanetResult> call, Response<PlanetResult> response)
            {


                Log.d("APIPlug", "Successfully response fetched" );
                edSearch.setText("");
                PlanetResult planets = response.body();
